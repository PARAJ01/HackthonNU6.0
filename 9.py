...
def generate_bar_chart(moisture, temp, ph):
    ...
    ax.bar(['Moisture', 'Temperature', 'pH'], [moisture, temp, ph], color=['#00BFFF', '#FF4500', '#32CD32'])
...
if not st.session_state.welcome_done:
    st.markdown("""
        ...
        <div class='welcome-text'>🌱 Welcome to Soil Analysis System</div>
...
selection = st.sidebar.radio("📍 Go to", ["🏠 Home", "🔬 Soil Analysis", "ℹ️ About"], key="navigation")
